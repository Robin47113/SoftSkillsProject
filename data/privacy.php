...
<html lang="de">
    <head>
        ...
        <title>Datenschutz | Hydration Tracker</title>
    </head>
    <body>
        <header class="header">
        ...
        <p>Stand: 26. Juli 2022</p>

        <h2>Inhaltsübersicht</h2> 
        <ul>
        <li><a class="textlink" href="#m3">Verantwortlich</a></li>
        <li><a class="textlink" href="#mOverview">Übersicht der Verarbeitungen</a></li>
        <li><a class="textlink" href="#m13">Maßgebliche Rechtsgrundlagen</a></li>
        <li><a class="textlink" href="#m27">Sicherheitsmaßnahmen</a></li>
        <li><a class="textlink" href="#m25">Übermittlung von personenbezogenen Daten</a></li>
        <li><a class="textlink" href="#m24">Datenverarbeitung in Drittländern</a></li>
        <li><a class="textlink" href="#m12">Löschung von Daten</a></li>
        <li><a class="textlink" href="#m134">Einsatz von Cookies</a></li>
        <li><a class="textlink" href="#m225">Bereitstellung des Onlineangebotes und Webhosting</a></li>
        <li><a class="textlink" href="#m367">Registrierung, Anmeldung und Nutzerkonto</a></li>
        <li><a class="textlink" href="#m432">Community Funktionen</a></li>
        <li><a class="textlink" href="#m451">Single-Sign-On-Anmeldung</a></li>
        <li><a class="textlink" href="#m104">Blogs und Publikationsmedien</a></li>
        <li><a class="textlink" href="#m328">Plugins und eingebettete Funktionen sowie Inhalte</a></li>
        <li><a class="textlink" href="#m15">Änderung und Aktualisierung der Datenschutzerklärung</a></li>
        <li><a class="textlink" href="#m10">Rechte der betroffenen Personen</a></li>
        <li><a class="textlink" href="#m42">Begriffsdefinitionen</a></li>
        </ul>


        <h2 id="m3">Verantwortlich</h2>
        <p>Softskills - Gruppe 24<br>Ammerländer Heerstraße 114-118<br>26129 Oldenburg</p>
        <p>Vertretungsberechtigte Personen: Kevin Janetzki, Markus Osterloh, Tim Schröder, Robin Visser, Maximilian Bosse.</p>
        <p>E-Mail-Adressen: 
        <a class="textlink" href="mailto:kevin.janetzki@uni-oldenburg.de">kevin.janetzki@uni-oldenburg.de</a>,
        <a class="textlink" href="mailto:markus.osterloh@uni-oldenburg.de">markus.osterloh@uni-oldenburg.de</a>,
        <a class="textlink" href="mailto:tim.schroeder@uni-oldenburg.de">tim.schroeder@uni-oldenburg.de</a>,
        <a class="textlink" href="mailto:robin.visser@uni-oldenburg.de">robin.visser@uni-oldenburg.de</a>,
        <a class="textlink" href="mailto:maximilian.bosse@uni-oldenburg.de">maximilian.bosse@uni-oldenburg.de</a>.
        </p>
        <a class="btn-fwd btn-st btn-light" href="imprint.php"><span>zum Impressum</span></a>
        ...
        <ul>
          ...
          <li>Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten, Daten des Untersatzes).</li>
        </ul>
        ...
        <ul>
          ...
          <li>Kontaktanfragen und Kommunikation.</li><li>Sicherheitsmaßnahmen.</li>
        ...
        <p><strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out): </strong> Abhängig davon, ob die Verarbeitung auf Grundlage einer Einwilligung oder gesetzlichen Erlaubnis erfolgt, haben Sie jederzeit die Möglichkeit, eine erteilte Einwilligung zu widerrufen oder der Verarbeitung Ihrer Daten durch Cookie-Technologien zu widersprechen (zusammenfassend als "Opt-Out" bezeichnet). Sie können Ihren Widerspruch zunächst mittels der Einstellungen Ihres Browsers erklären, z.B., indem Sie die Nutzung von Cookies deaktivieren (wobei hierdurch auch die Funktionsfähigkeit unseres Onlineangebotes eingeschränkt werden kann). Ein Widerspruch gegen den Einsatz von Cookies zu Zwecken des Onlinemarketings kann auch mittels einer Vielzahl von Diensten, vor allem im Fall des Trackings, über die Webseiten <a class="textlink" href="https://optout.aboutads.info" target="_blank">https://optout.aboutads.info</a> und <a class="textlink" href="https://www.youronlinechoices.com/" target="_blank">https://www.youronlinechoices.com/</a> erklärt werden. Daneben können Sie weitere Widerspruchshinweise im Rahmen der Angaben zu den eingesetzten Dienstleistern und Cookies erhalten.</p>
        <ul class="list-wide">
        ...
        <ul class="list-wide">
          ...
          <li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li><li><strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit, Content Delivery Network (CDN).</li>
          <li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).</li>
        </ul>
        <p><strong>Eingesetzte Dienste und Diensteanbieter:</strong></p>
        <ul class="list-wide">
          <li>
          <strong>Google-CDN:</strong> Wir binden die Javascript-Bibliotheken jQuery und jQuery UI ein und um dabei eine bestmögliche Nutzungserfahrung zu bieten, nutzen wir das CDN von Google. Mit großer Wahrscheinlichkeit haben Sie diese Bibliothek bereits auf anderen Seiten aus dem Google-CDN heruntergeladen, sodass sie aus dem Browser-Cache direkt und ohne erneuten Download verwendet werden kann. Andernfalls werden Daten vom Browser an Google Inc. ("Google") übertragen. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen in den genannten Zwecken.       Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a class="textlink" href="https://developers.google.com/speed/libraries" target="_blank">https://developers.google.com/speed/libraries</a>; Datenschutzerklärung: <a class="textlink" href="https://www.google.de/intl/de/policies/privacy/" target="_blank">https://www.google.de/intl/de/policies/privacy/</a>.
          </li>
        </ul>
        ...
        <ul class="list-wide">
          ...
          <li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Kundenservice, Anmeldeverfahren.</li>
        ...
        <p><strong>Eingesetzte Dienste und Diensteanbieter:</strong></p>
        <ul class="list-wide">
          <li><strong>Google Single-Sign-On:</strong> Authentifizierungsdienst; Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a class="textlink" href="https://www.google.de" target="_blank">https://www.google.de</a>; Datenschutzerklärung: <a class="textlink" href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>; Widerspruchsmöglichkeit (Opt-Out): Einstellungen für die Darstellung von Werbeeinblendungen: <a class="textlink" href="https://adssettings.google.com/authenticated" target="_blank">https://adssettings.google.com/authenticated</a>.</li>
        </ul>  
        ...
        <ul class="list-wide">
          <li><strong>Google Fonts:</strong> Wir binden die Schriftarten ("Google Fonts") des Anbieters Google ein, wobei die Daten der Nutzer allein zu Zwecken der Darstellung der Schriftarten im Browser der Nutzer verwendet werden. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen an einer technisch sicheren, wartungsfreien und effizienten Nutzung von Schriftarten, deren einheitlicher Darstellung sowie unter Berücksichtigung möglicher lizenzrechtlicher Restriktionen für deren Einbindung. Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a class="textlink" href="https://fonts.google.com/" target="_blank">https://fonts.google.com/</a>; Datenschutzerklärung: <a class="textlink" href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>.</li>  
          <li><strong>Shariff:</strong> Wir verwenden die datenschutzsicheren "Shariff“-Schaltflächen. "Shariff“ wurde entwickelt, um mehr Privatsphäre im Netz zu ermöglichen und die üblichen "Share"-Buttons der sozialen Netzwerke zu ersetzen. Dabei stellt nicht der Browser der Nutzer, sondern der Server, auf dem sich dieses Onlineangebot befindet, eine Verbindung mit dem Server der jeweiligen Social-Media-Plattformen her und fragt z.B. die Anzahl von Likes ab. Der Nutzer bleibt anonym. Mehr Informationen zum Shariff-Projekt finden Sie bei den Entwicklern des Magazins c't: <a class="textlink" href="https://www.heise.de/ct/artikel/Shariff-Social-Media-Buttons-mit-Datenschutz-2467514.html" target="_blank">https://www.heise.de/ct/artikel/Shariff-Social-Media-Buttons-mit-Datenschutz-2467514.html</a>; Dienstanbieter: Heise Medien GmbH &amp; Co. KG, Karl-Wiechert-Allee 10, 30625 Hannover, Deutschland; Website: <a class="textlink" href="https://www.heise.de/ct/artikel/Shariff-Social-Media-Buttons-mit-Datenschutz-2467514.html" target="_blank">https://www.heise.de/ct/artikel/Shariff-Social-Media-Buttons-mit-Datenschutz-2467514.html</a>; Datenschutzerklärung: <a class="textlink" href="https://www.heise.de/Datenschutzerklaerung-der-Heise-Medien-GmbH-Co-KG-4860.html" target="_blank">https://www.heise.de/Datenschutzerklaerung-der-Heise-Medien-GmbH-Co-KG-4860.html</a>.</li>
        </ul>
        ...
        <p><a class="textlink" href="https://datenschutz-generator.de/?l=de" title="Rechtstext von Dr. Schwenke - für weitere Informationen bitte anklicken." target="_blank" rel="noopener noreferrer nofollow">Erstellt mit kostenlosem Datenschutz-Generator.de von Dr. Thomas Schwenke</a></p>
        </article>
